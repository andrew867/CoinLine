...
Add optional long-form **supplemental** materials here (PDFs, operator addenda) that are **not** part of the MkDocs nav unless you link them explicitly from `docs-site/`.
